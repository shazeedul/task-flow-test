                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control"
                                placeholder="{{ localize('Enter Title') }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control basic-single"
                                ...
                                <option value="not_started">{{ localize('Not Started') }}</option>
                                <option value="in_progress">{{ localize('In Progress') }}</option>
                                <option value="completed">{{ localize('Completed') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12">
